...
datatype geom_exp = 
         ...
         | Var of string
         (* Problem #2, add shift expression. *)
...
fun eval_prog (e,env) =
    case e of
      ...
      (* Problem #2, add a case for Shift expression. *)
...
(* Problem #1, add function preprocess_prog of type geom_exp -> geom_exp *)
(* Pre : Takes a geom_exp.
   Post: Preprocess the geom_exp and returns the preprocessed geom_exp. *)
